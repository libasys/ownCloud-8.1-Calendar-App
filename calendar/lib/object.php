...
class Object{
   ...
   /**
	...
	public static function add($id,$data, $shared=false, $eventid=0) {
		...
		$stmt = \OCP\DB::prepare( 'INSERT INTO `*PREFIX*clndr_objects` (`calendarid`,`objecttype`,`startdate`,`enddate`,`repeating`,`summary`,`calendardata`,`uri`,`lastmodified`,`isalarm`,`eventuid`,`relatedto`,`org_objid`,`userid`) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?)' );
		$stmt->execute($values);
	...
	public static function addFromDAVData($id,$uri,$data) {
		...
		$stmt = \OCP\DB::prepare( 'INSERT INTO `*PREFIX*clndr_objects` (`calendarid`,`objecttype`,`startdate`,`enddate`,`repeating`,`summary`,`calendardata`,`uri`,`lastmodified`,`isalarm`,`eventuid`,`relatedto`) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)' );
   ...
   /**
	...
	public static function updateVCalendarFromRequest($request, $vcalendar) {
		...
		$firstDayOfWeek=';WKST='.(\OCP\Config::getUserValue(\OCP\USER::getUser(), 'calendar', 'firstday', 'mo') == 'mo' ? 'MO' : 'SU');
	...
	public static function getowner($id) {
		...
		//\OCP\Util::writeLog('calendar','OWNER'.$event['calendarid'].' of '.$event['summary'], \OCP\Util::DEBUG);
