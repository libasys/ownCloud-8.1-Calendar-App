...
class Backend extends \Sabre\CalDAV\Backend\AbstractBackend  {
	 ...
	 */
	 public function createCalendar($principalUri,$calendarUri, array $properties) {
        ...
        return \OCA\Calendar\Calendar::addCalendarFromDAVData($principalUri,$calendarUri,$values['displayname'],$values['components'],$values['timezone'],$values['calendarorder'],$values['calendarcolor'],$values['transparent']);
    }
	...
	public function createCalendarObject($calendarId,$objectUri,$calendarData) {
		...
		if($calendar['userid'] != \OCP\User::getUser()) {
			...
			if (!$sharedCalendar || !($sharedCalendar['permissions'] & \OCP\PERMISSION_UPDATE)) {	
				$bAccess=false;
				$calendarData=null;
				\OCP\Util::writeLog('calendar', 'CALDAV -> CREATE Permission denied! Calendar '.$calendar['displayname'], \OCP\Util::DEBUG);
			}
		}
		if($bAccess === true){	
