...
class EventController extends Controller {
    ...
    public function getNewFormEvent() {
		...
		if (!$end) {
			$duration = $this-> configInfo ->getUserValue($this -> userId, 'calendar', 'duration', '60');
        ...
        $response = new TemplateResponse('calendar', 'part.newevent',$params, '');  
    ...
    public function getEditFormEvent() {
      ...
      $params = [
       ...
       if ($editInfo['permissions'] & \OCP\PERMISSION_UPDATE) {
           $response = new TemplateResponse('calendar', 'part.editevent',$params, '');  
