...
<div  class="button-group" style="width:46.5%; float:left;">
	...
	<?php if($_['bShareOnlyEvent'] && $_['permissions'] & OCP\PERMISSION_SHARE) { ?>	 
			<button class="button" id="editEvent-add"  name="addSharedEvent" data-link="<?php print_unescaped(\OC::$server->getURLGenerator()->linkToRoute('calendar.event.addSharedEvent')) ?>"><?php p($l->t("Add"));?></button>
